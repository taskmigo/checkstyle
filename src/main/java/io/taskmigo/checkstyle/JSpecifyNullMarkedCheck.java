...
/**
 * Requires existing {@code package-info.java} files to opt into JSpecify null-marked semantics.
 *
 * <p>Package presence is deliberately handled by Checkstyle's built-in {@code JavadocPackage}
 * check.
 */
@StatelessCheck
